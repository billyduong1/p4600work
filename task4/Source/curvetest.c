...
void main(int argc, char** argv)
{
  ...
  }  /*JAMES: Now you need to have it so something if input_file == NULL, like exit the program*/
  ...
  int x[] = {i};   //sets x to the numbers generated by the noisy sin wave 
                /*JAMES: This does not do what you think it does!
                This just creates a pointer and then assigns the integer i to it, which 
                is the number of numbers read in.
  ...
  /* Not sure why you need this your variable "i" further up alread contains how long x
  is so no need to calculate it again here - just use i instead of count 

  Also you just set the length of the arrNumbers array to 5 -> why do you need to work it out?*/
